...
class My_FEV_Dataset(Dataset):
    ...
    def __getitem__(self, item):
        ...
        label_intensity = self.label.loc[e_index, 'Intensity']
        ...
        label_intensity = torch.as_tensor(np.array(label_intensity))
        label_valence = torch.as_tensor(np.array(label_valence))
        label_arousal = torch.as_tensor(np.array(label_arousal))
        return face, eyedata, videodata, label_emotion, label_intensity, label_valence, label_arousal
        # return face, eyedata, videodata, label_emotion, label_valence, label_arousal,item
